...
m12_cells = [
    ...
    nbf.v4.new_code_cell("grc_utils.display_deliverable_anchor('VAL-01', 'Independent Validation Report (§6.4)')"),
...
val_df = grc_utils.generate_validation_drift_data()
grc_utils.display_validation_consistency_scatter(val_df)
"""),
    nbf.v4.new_markdown_cell("""
...
m13_cells = [
    ...
    nbf.v4.new_code_cell("grc_utils.display_deliverable_anchor('MSC-04', 'MITRE ATLAS Vulnerability Matrix (§16.9)')"),
    nbf.v4.new_markdown_cell("""
...
"""),
    nbf.v4.new_code_cell("""
attacker_df = grc_utils.generate_attacker_capability_data()
grc_utils.display_attacker_tactic_sunburst(attacker_df)
"""),
    nbf.v4.new_markdown_cell("""
...
"""),
    nbf.v4.new_code_cell("""
surface_df = grc_utils.generate_adversarial_surface_data()
grc_utils.display_adversarial_surface_3d(surface_df)
"""),
    nbf.v4.new_markdown_cell("""
...
"""),
    nbf.v4.new_code_cell("""
grc_utils.display_remediation_waterfall(None) # Static data inside function for demo
"""),
    nbf.v4.new_markdown_cell("""
...
"""),
    nbf.v4.new_code_cell("""
aging_df = grc_utils.generate_redteam_findings_history()
grc_utils.display_redteam_vulnerability_aging(aging_df)
""")
]
...
m14_cells = [
    ...
    nbf.v4.new_code_cell("grc_utils.display_deliverable_anchor('IRT-01', 'Incident Triage & Resolution Velocity (Part VII)')"),
    nbf.v4.new_markdown_cell("""
...
"""),
    nbf.v4.new_code_cell("""
ir_df = grc_utils.generate_incident_timeline_data()
grc_utils.display_ir_velocity_dashboard(ir_df)
"""),
    nbf.v4.new_markdown_cell("""
...
"""),
    nbf.v4.new_code_cell("""
sankey_data = grc_utils.generate_incident_lineage_data()
grc_utils.display_incident_sankey(sankey_data)
"""),
    nbf.v4.new_markdown_cell("""
...
grc_utils.display_3d_incident_cube(ir_df)
"""),
    nbf.v4.new_markdown_cell("""
...
"""),
    nbf.v4.new_code_cell("""
blast_df = grc_utils.generate_blast_radius_simulation()
grc_utils.display_blast_radius_waterfall(blast_df)
""")
]
...
m15_cells = [
    ...
    nbf.v4.new_code_cell("grc_utils.display_deliverable_anchor('FAIR-01', 'Algorithmic Fairness Audit & Mitigation')"),
    nbf.v4.new_markdown_cell("""
...
m16_cells = [
    ...
    nbf.v4.new_code_cell("grc_utils.display_deliverable_anchor('XAI-01', 'Reasoning Traceability & Hallucination Audit')"),
    nbf.v4.new_markdown_cell("""
...
ragas_full_suite = grc_utils.generate_ragas_metrics()
grc_utils.display_ragas_spider_chart(ragas_full_suite)
"""),
    nbf.v4.new_markdown_cell("""
...
"""),
    nbf.v4.new_code_cell("""
audit_trace = grc_utils.generate_rag_failure_trace()
grc_utils.display_claim_grounding_audit(audit_trace)
"""),
    nbf.v4.new_markdown_cell("""
...
"""),
    nbf.v4.new_code_cell("""
graph_data = grc_utils.generate_retrieval_graph_data()
grc_utils.display_rag_knowledge_graph(graph_data)
""")
]
