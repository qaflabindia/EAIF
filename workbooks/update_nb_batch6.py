...
m17_cells = [
    ...
    nbf.v4.new_code_cell("grc_utils.display_deliverable_anchor('MSC-09', 'AI-SBOM & Lineage Audit Artifact')"),
...
m18_cells = [
    ...
    nbf.v4.new_code_cell("grc_utils.display_deliverable_anchor('REG-01', 'Harmonized Compliance Framework')"),
    nbf.v4.new_markdown_cell("""
...
m19_cells = [
    ...
    nbf.v4.new_code_cell("grc_utils.display_deliverable_anchor('BRD-01', 'Executive Governance KPI Dashboard')"),
    nbf.v4.new_markdown_cell("""
