...
grc_utils.display_liability_card(inventory['liability'].sum(), len(high_risk), len(inventory))
grc_utils.display_interactive_risk_map(inventory)
"""),
    nbf.v4.new_code_cell("grc_utils.display_liability_scatter(inventory)")
]
...
m01_cells = [
    ...
    nbf.v4.new_code_cell("grc_utils.display_deliverable_anchor('B', 'Enterprise AI Risk-Tiering Model')"),
    nbf.v4.new_code_cell("""
inventory = grc_utils.load_inventory('ai_inventory_master.csv')
def assign_gate(row):
...
grc_utils.display_velocity_stats(inventory)
grc_utils.display_intake_sankey(inventory)
""")
]
...
m02_cells = [
    ...
    nbf.v4.new_code_cell("grc_utils.display_deliverable_anchor('F', 'Governance Forums & Roles')"),
    nbf.v4.new_code_cell("""
inventory = grc_utils.load_inventory('ai_inventory_master.csv')
grc_utils.display_ownership_heatmap(inventory)
grc_utils.display_accountability_sankey(inventory)
""")
]
...
m03_cells = [
    ...
    nbf.v4.new_code_cell("grc_utils.display_deliverable_anchor('A/D', 'Standardized Asset Catalog & Lifecycle Map')"),
    nbf.v4.new_code_cell("""
catalog = grc_utils.generate_app_store_catalog(n=200)
grc_utils.display_app_catalog_sunburst(catalog)
grc_utils.display_capability_risk_matrix(catalog)
""")
]
...
m04_cells = [
    ...
    nbf.v4.new_code_cell("grc_utils.display_deliverable_anchor('C', 'Detailed Enterprise AI Risk Taxonomy')"),
    nbf.v4.new_code_cell("""
risk_lib = grc_utils.generate_risk_taxonomy()
grc_utils.display_risk_taxonomy_sunburst(risk_lib)
profiles = [
...
grc_utils.display_risk_radar(profiles)
grc_utils.display_residual_risk_heatmap(risk_lib)
""")
]
...
m05_cells = [
    ...
    nbf.v4.new_code_cell("grc_utils.display_deliverable_anchor('B/D', 'Automated Risk-Tiering & Lifecycle Paved Road')"),
    nbf.v4.new_code_cell("""
inventory = grc_utils.load_inventory('ai_inventory_master.csv')
grc_utils.display_governance_paved_road(inventory)
metrics = grc_utils.calculate_velocity_metrics(inventory)
grc_utils.display_velocity_gauges(metrics)
""")
]
...
m06_cells = [
    ...
    nbf.v4.new_code_cell("grc_utils.display_deliverable_anchor('E', 'High-Fidelity Training Lineage Depth Analysis')"),
...
"""),
    nbf.v4.new_code_cell("""
lineage = grc_utils.generate_training_lineage(n=50)
grc_utils.display_transformation_waterfall(lineage)
"""),
    nbf.v4.new_markdown_cell("""
...
"""),
    nbf.v4.new_code_cell("""
grc_utils.display_lineage_depth_sunburst(lineage)
"""),
    nbf.v4.new_markdown_cell("""
...
"""),
    nbf.v4.new_code_cell("""
grc_utils.display_quality_vs_risk_scatter(lineage)
"""),
    nbf.v4.new_markdown_cell("""
...
"""),
    nbf.v4.new_code_cell("""
grc_utils.display_sovereignty_map(lineage)
""")
]
...
m07_cells = [
    ...
    nbf.v4.new_code_cell("grc_utils.display_deliverable_anchor('G', 'Active Strategy & Red-Team Evidence')"),
    nbf.v4.new_markdown_cell("""
...
"""),
    nbf.v4.new_code_cell("""
revocation_df = grc_utils.generate_vulnerability_lifecycle_data()
grc_utils.display_security_vulnerability_waterfall(revocation_df)
"""),
    nbf.v4.new_markdown_cell("""
...
"""),
    nbf.v4.new_code_cell("""
red_team_logs = grc_utils.generate_detailed_red_team_logs()
grc_utils.display_resilience_heatmap(red_team_logs)
"""),
    nbf.v4.new_markdown_cell("""
...
"""),
    nbf.v4.new_code_cell("""
grc_utils.display_defense_velocity_dashboard(revocation_df)
"""),
    nbf.v4.new_markdown_cell("""
...
"""),
    nbf.v4.new_code_cell("""
sec_df = grc_utils.generate_security_posture_data()
grc_utils.display_security_vault_dashboard(sec_df)
""")
]
