...
m08_cells = [
    ...
    nbf.v4.new_code_cell("aigrc_utils.display_deliverable_anchor('PRM', 'Adversarial Prompting & Version Control')"),
...
adv_data = aigrc_utils.generate_adversarial_prompt_data()
aigrc_utils.display_prompt_safety_attrition_waterfall(adv_data)
"""),
    nbf.v4.new_markdown_cell("""
...
"""),
    nbf.v4.new_code_cell("""
drift_df = aigrc_utils.generate_prompt_version_safety_scores()
aigrc_utils.display_prompt_drift_analysis(drift_df)
"""),
    nbf.v4.new_markdown_cell("""
...
"""),
    nbf.v4.new_code_cell("""
heatmap_df = aigrc_utils.generate_injection_vector_data(adv_data)
aigrc_utils.display_injection_vector_heatmap(heatmap_df)
""")
]
...
m09_cells = [
    ...
    nbf.v4.new_code_cell("aigrc_utils.display_deliverable_anchor('RAG', 'Knowledge Base Integrity & Claim Verification')"),
    nbf.v4.new_markdown_cell("""
...
"""),
    nbf.v4.new_code_cell("""
rag_perf_df = aigrc_utils.generate_rag_performance_data()
aigrc_utils.display_rag_faithfulness_radar(rag_perf_df)
"""),
    nbf.v4.new_markdown_cell("""
...
"""),
    nbf.v4.new_code_cell("""
aigrc_utils.display_hallucination_trend_dashboard(rag_perf_df)
"""),
    nbf.v4.new_markdown_cell("""
...
"""),
    nbf.v4.new_code_cell("""
integrity_df = aigrc_utils.generate_retrieval_integrity_logs()
aigrc_utils.display_retrieval_integrity_matrix(integrity_df)
""")
]
...
m10_cells = [
    ...
    nbf.v4.new_code_cell("aigrc_utils.display_deliverable_anchor('AGT', 'Degrees of Freedom & Kill-switch Protocol')"),
    nbf.v4.new_markdown_cell("""
...
"""),
    nbf.v4.new_code_cell("""
agent_gov_df = aigrc_utils.generate_agentic_governance_data()
aigrc_utils.display_agent_autonomy_radar(agent_gov_df)
"""),
    nbf.v4.new_markdown_cell("""
...
"""),
    nbf.v4.new_code_cell("""
aigrc_utils.display_tool_limit_attrition_waterfall(agent_gov_df)
"""),
    nbf.v4.new_markdown_cell("""
...
"""),
    nbf.v4.new_code_cell("""
kill_metrics_df = aigrc_utils.generate_killswitch_metrics()
aigrc_utils.display_killswitch_velocity_chart(kill_metrics_df)
""")
]
...
m11_cells = [
    ...
    nbf.v4.new_code_cell("aigrc_utils.display_deliverable_anchor('C', 'Model & System Cards (§12.1)')"),
    nbf.v4.new_markdown_cell("""
...
"""),
    nbf.v4.new_code_cell("""
acc_df = aigrc_utils.generate_accountability_profile_data()
aigrc_utils.display_accountability_radar(acc_df)
"""),
    nbf.v4.new_markdown_cell("""
...
"""),
    nbf.v4.new_code_cell("""
lineage_data = aigrc_utils.generate_metadata_lineage_data()
aigrc_utils.display_documentation_sankey(lineage_data)
"""),
    nbf.v4.new_markdown_cell("""
...
"""),
    nbf.v4.new_code_cell("""
aigrc_utils.display_compliance_gap_waterfall(acc_df)
"""),
    nbf.v4.new_markdown_cell("""
...
"""),
    nbf.v4.new_code_cell("""
cube_df = aigrc_utils.generate_3d_risk_cube_data()
aigrc_utils.display_3d_risk_landscape(cube_df)
""")
]
